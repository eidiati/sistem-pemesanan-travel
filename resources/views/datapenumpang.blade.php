...
<header class="bg-white shadow my-auto">
    <div class="mx-auto max-w-7xl px-2 py-3 sm:px-3 lg:px-4">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900">Informasi Penumpang</h1>
    </div>
</header>
<main>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            Jl. Srikandri RT01 / RW02/ No. 14, Pekanbaru
                        </td>
                        <td class="px-6 py-4">
                            Pelabuhan Tanjung Buton, Mengkapan, Siak
                        </td>
                        <td class="px-6 py-4">
                            081234567890
                        </td>
