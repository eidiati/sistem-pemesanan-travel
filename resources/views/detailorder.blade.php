...
<header class="bg-white shadow my-auto">
    <div class="mx-auto max-w-7xl px-2 py-3 sm:px-3 lg:px-4">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900">Detail Pemesanan Travel</h1>
    </div>
</header>
<main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="grid grid-rows-1">
                <h3 class="text-xl font-bold tracking-tight daark:text-white text-center pb-6">Detail</h3>
                {{-- card 1--}}
