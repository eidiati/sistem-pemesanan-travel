    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
            {{-- <div class="p-3 justify-items-center">
                ...
                <!-- Modal toggle -->
                <a href="{{ route('admin.riwayat')}}?export=pdf" class="block text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
        ...
        {{-- Table --}}
        @livewire('riwayat-table', ['pesanan' => $pesanan])
