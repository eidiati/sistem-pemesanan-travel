...
<main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-column sm:flex-row flex-wrap space-y-2 sm:space-y-0 items-center justify-between pb-2">
            ...
            <div class="pb-3 justify-items-center">
                {{-- <p>Berikut ini daftar jadwal keberangkatan anda</p> --}}
                <!-- Modal toggle -->
                {{-- <button data-modal-target="createJadwal" data-modal-toggle="createJadwal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                    Tambah
                </button> --}}
        ...
        @if(Auth::user()->id_role == 3)
            @livewire("jadwal-user")
        @elseif(Auth::user()->id_role == 2)
            @livewire('jadwal-driver')
        @endif
